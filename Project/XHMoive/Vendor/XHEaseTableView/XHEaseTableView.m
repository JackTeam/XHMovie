...
@interface XHEasyTableViewCell : UITableViewCell

- (void)prepareForReuse;

@end

@implementation XHEasyTableViewCell
...
@implementation XHEaseTableView
...
- (void)setDefaultSelectedIndexPath:(NSIndexPath *)defaultSelectedIndexPath {
    ...
    self.selectedIndexPath = _defaultSelectedIndexPath;
...
- (UITableViewCell *)tableView:(UITableView *)aTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    if (cell == nil) {
        cell = [[XHEasyTableViewCell alloc] initWithStyle:UITableViewCellStyleDefault reuseIdentifier:CellIdentifier];
